...
Finally, bring this back to the shelling sequence and this week's epigraph. The film spends its opening credits on a body built as pure image — assembled, finished, and put on display before anyone asks what's inside it. When you generate a face, a figure, or a body this week, who is authoring that manufactured appearance: you, for writing the prompt; the model, for the training data it draws on; or no one in particular, in the same way no one quite authors the Major's shell? Put Haraway's cyborg in conversation with Demsky's account of prompting Midjourney toward images he could live with: does treating a generated body as a Haraway-style cyborg change how responsible you feel for what it looks like, or does the boundary-crossing she celebrates just make the authorship question harder to answer, not easier?
